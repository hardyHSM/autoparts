...
import { selectionConfig } from './selection.model.js'
                        ...
                        <tr class="table__row">
                            ...
                            <th class="table__col table__col_ultra-small">
                                <a class="button button_mini button_accent button_icon-only"
                                   data-state="${selectionConfig.states.general}"
                                   data-type="menu"
                                   href="${selectionConfig.router.edit}${selection._id}">
                                    Изменить
                                    <svg>
            ...
            <form method="post" class="form admin-panel__form" data-admin-form>
                ...
                <div class="form__row form__bottom">
                    ...
                    <a class="button button_neutral button_icon"
                       data-state="back"
                       data-type="menu"
                       href="${selectionConfig.router.general}">
