            ...
            <div class="product-module__header">
                ...
                <div class="product-module__info">
                    <div class="product-module__row">
                        ...
                        ${res.count
                            ? `<button class="button button_accent" data-add-product data-id="${res._id}">Добавить в корзину</button>`
                            : `<button class="button button_accent button_disabled" data-id="${res._id}" disabled>Товара нет на складе</button>`
                        }
                    </div>
                                    ...
                                    if(!Array.isArray(value)) {
                                        acc += `
                                            <div class="properties__item">
                                                ...
                                                <dd class="properties__value"><a href="/search/attributes?key=${key}&value=${value}" class="properties__text">${value}</a></dd>
                                            </div>`
                                    } else {
                                        acc += `
                                            <div class="properties__item">
