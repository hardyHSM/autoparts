...
export function renderOrderProducts(data) {
    ...
    return `
        ...
        <p class="order-products__descr">Информация о цене и наличии товара, а также о стоимости и условиях доставки является предварительной и будет уточнена в момент оформления заказа.</p>
