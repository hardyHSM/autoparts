            ...
            <form action="#">
                <div class="page-popup__block">
                    <div class="page-input">
                        <input type="email"  name="email" class="page-popup__input page-input__field" placeholder="E-mail" data-email/>
                    </div>
                </div>
                <div>
                    <div class="page-input">
                        <input type="password" name="password" autocomplete="off" class="page-popup__input page-input__field" placeholder="Пароль" data-pass/>
                    </div>
    ...
    forgetPass:
        `
            ...
            <form action="#">
                <div class="page-popup__block">
                    <div class="page-input">
                        <input type="email" autocomplete="off" class="page-popup__input page-input__field" placeholder="E-mail" data-email/>
                    </div>
                </div>
